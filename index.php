    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="pentool.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h1 class="display-4">PENTOL CORAH MENYAPAMU!<br><span class="font-weight-bold">BocilCuy!</span></h1>
                    <h5>Kelezatan Pentol Corah di BocilCuy!</h5>
                    <p>Kamu dapat menemukan kelezatan dan kenikmatan pentol corah yang ada dimadiun dengan saus sambal yang pedas</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="ceker.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Kriyuk-Kriyuk Nyoi</h5>
                    <p>Nikmati Kerenyahan Ceker Goreng Kami Tanpa Kletukan Tulang</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="gochujang.png" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Pedes Banget Cuy</h5>
                    <p>Pedesnya bikin tergila-gila</p>
                </div>
            </div>
        </div>
