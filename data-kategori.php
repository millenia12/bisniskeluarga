                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit-kategori.php?id=<?php echo $row['category_id'] ?> ">Edit</a> || <a href="delete.php?idk=<?php echo $row['category_id'] ?>" onclick="return confirm('Apakah Data ingin Dihapus?') ">Delete</a>
                                </td>
